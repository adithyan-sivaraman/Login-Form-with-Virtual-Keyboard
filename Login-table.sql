...
--
-- Host: localhost    Database: assetbot
-- ------------------------------------------------------
...
CREATE TABLE `login` (
  ...
  `user_status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2023-07-25 22:01:36
